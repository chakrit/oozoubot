...
module.exports = (robot) ->
  ...
  robot.respond /brace yourselves (.*)/i, (msg) ->
    memeGenerator msg, 21254, 1162778, "brace yourselves", msg.match[1], (url) ->
      msg.send url
  ...
  robot.respond /janify (.*)/i, (msg) ->
    memeGenerator msg, 6443, 6994178, "", khanify(msg.match[1]), (url) ->
      msg.send url
